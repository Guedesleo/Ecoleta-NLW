...
const CreatePoint= ()=>{
    ...
    //para fazer geolocalizacao da maquina const [initialPosition , setInitialPosition] = useState<[number,number]>([0,0]);
   ...
   const history = useHistory();
    ...
    useEffect(() => {
        //carregar as cidades smepre que a Uf mudar
        if(selectedUf === '0'){
            return;
        }
        axios
            ...
            <form onSubmit={handleSubmit}>
               ...
               <fieldset>
                   <legend>
                     ...
                     <Map center={[-23.5296501 ,-46.718843]} zoom={15} onClick ={handleMapClick} >
                         <TileLayer
