# Ecoleta-NlW<h3 align="center">
<h3>
    <img alt="Logo" title="#logo" width="700px" src=".github/Home-logo.PNG">
    <br><br>
...
<h1 align="center">
    ...
    <img alt="NextLevelWeek" title="#NextLevelWeek" src=".github/web.PNG" width="700px">
...
<h1 align="center">
    <img alt="Mobile Home" src=".github/home-mobile.PNG" width="300px">
    <img alt="Mobile Detail" src=".github/detail-mobile.PNG" width="300px">
</h1>
...
```sh
  $ git clone https://github.com/Guedesleo/Ecoleta-Curso.git
```
